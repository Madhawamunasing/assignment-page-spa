...
const SocialSharing = () => {
  ...
  const eventTitle = 'Reimagine Banking - Finastra Event';
  ...
  const platforms = [
    ...
    {
      name: 'LinkedIn',
      url: `https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(shareUrl)}&title=${encodeURIComponent(eventTitle)}`,
    ...
    {
      name: 'WhatsApp',
      url: `https://wa.me/?text=${encodeURIComponent(`${eventTitle} - ${shareUrl}`)}`,
